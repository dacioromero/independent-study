...
public class Midterm {
	static String[] words = new String[] { "time", "person", "year", "way", "day", "thing", "man", "world", "life",
			"hand", "part", "child", "eye", "woman", "place", "work", "week", "case", "point", "government", "company",
	...
	static void Game() {
		...
		for (int guessCount = word.length() * 2; guessCount > 0 && !win; guessCount--) {
			System.out.println(
					word.replaceAll(charGuesses.length() > 0 ? String.format("[^%s]", charGuesses) : ".", "_"));
